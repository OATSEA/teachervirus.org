<?php
// getgit.php is a modified version of getinfected.php
// It's used to update the teachervirus.org website
// Created: May 2015
...
if ($debug) { echo "<h1>Start <b>Teachervirus.org</b> update!</h1>";}
...
if (file_exists('updated')) {
    // if updated folder exists then don't update
    echo "<html><body><h2>This site is already UPDATED!</h2>
    <p>To update remove the <b>updated</b> directory.</p>
    </body></html>";
    exit("<h3>Site not updated!</h3>");
} else {
    if ($debug) { echo "<p>Directory <b>updated</b> doesn't exist so continue with update<p>"; }
    ...
    */
    $ip="no"; // don't use sideways infection
...
// ------------------------------------
if ($debug) { echo "<h2>Attempting to Download teachervirus.org</h2>"; }
